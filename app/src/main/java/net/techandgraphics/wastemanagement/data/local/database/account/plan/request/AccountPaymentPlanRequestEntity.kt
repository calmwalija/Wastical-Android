package net.techandgraphics.wastemanagement.data.local.database.account.plan.request
...
@Entity(
  tableName = "account_payment_plan_request",
  foreignKeys = [
    ForeignKey(
...
data class AccountPaymentPlanRequestEntity(
