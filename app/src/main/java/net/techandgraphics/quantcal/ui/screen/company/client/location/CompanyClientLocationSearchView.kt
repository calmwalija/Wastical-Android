...
@Composable
fun CompanyClientLocationSearchView(
  ...
  Row(verticalAlignment = Alignment.CenterVertically) {
    Card(
      ...
      BasicTextField(
        value = state.query,
        onValueChange = { onEvent(CompanyClientLocationEvent.Input.Search(it)) },
        maxLines = 1,
        ...
        decorationBox = { innerTextField ->
          Row(
            ...
            AnimatedVisibility(visible = state.query.isNotEmpty()) {
              IconButton(
                onClick = { onEvent(CompanyClientLocationEvent.Button.Clear) },
...
@Preview
@Composable
fun CompanyClientLocationSearchPreview() {
  QuantcalTheme {
    CompanyClientLocationSearchView(
