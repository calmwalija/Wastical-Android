...
import net.techandgraphics.quantcal.ui.screen.accountInfo4Preview
...
fun CompanyBrowseClientSearchView(
  ...
  Row(
    ...
    Card(
      ...
      BasicTextField(
        value = state.query,
        onValueChange = { onEvent(CompanyBrowseClientListEvent.Input.Search(it)) },
        maxLines = 1,
        ...
        decorationBox = { innerTextField ->
          Row(
            ...
            AnimatedVisibility(visible = state.query.isNotEmpty()) {
              IconButton(
                onClick = { onEvent(CompanyBrowseClientListEvent.Button.Clear) },
