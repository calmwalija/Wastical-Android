...
@Composable
fun CompanyVerifyClientSearchView(
  ...
  Row(
    ...
    Card(
      ...
      BasicTextField(
        value = state.query,
        onValueChange = { onEvent(CompanyVerifyPaymentEvent.Input.Search(it)) },
        maxLines = 1,
        ...
        decorationBox = { innerTextField ->
          Row(
            ...
            AnimatedVisibility(visible = state.query.isNotEmpty()) {
              IconButton(
                onClick = { onEvent(CompanyVerifyPaymentEvent.Button.Clear) },
...
@Preview
@Composable
fun CompanyVerifyClientSearchPreview() {
  WasticalTheme {
    CompanyVerifyClientSearchView(
      state = CompanyVerifyPaymentState.Success(
