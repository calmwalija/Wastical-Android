package net.techandgraphics.wastical.ui.screen.company.payment.verify.status
...
import net.techandgraphics.wastical.ui.screen.company.payment.verify.CompanyVerifyPaymentEvent
import net.techandgraphics.wastical.ui.screen.paymentRequestWithAccount4Preview
import net.techandgraphics.wastical.ui.theme.WasticalTheme


@Composable fun CompanyVerifyStatusWaitingView(
  ...
  Card(
    ...
    onClick = { onEvent(CompanyVerifyPaymentEvent.Goto.Profile(payment.accountId)) }
  ) {
...
@Preview
@Composable
private fun CompanyVerifyStatusWaitingPreview() {
  WasticalTheme {
