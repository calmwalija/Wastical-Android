package net.techandgraphics.wastical.account
...
import net.techandgraphics.wastical.keycloak.AccessTokenResponse
import net.techandgraphics.wastical.keycloak.JwtAccount
...
class AuthenticatorHelper @Inject constructor(private val accountManager: AccountManager) {
  ...
  companion object {
    private const val ACCOUNT_TYPE = "net.techandgraphics.wastical"
